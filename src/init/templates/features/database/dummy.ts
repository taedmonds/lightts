...
export const addDatabaseDummyTemplate = (project: Project, data: AddDatabaseCommandProps) => {
    const sourceFile = project.createSourceFile(join(DATABASE_DIR, 'dummy', 'index.ts'), '', {
        overwrite: true
    });
        ...
        declarations: [
            {
                ...
                initializer: (writer) => {
                    ...
                    writer.write(`migrationsTableName: 'migration_dummy',\n`);
